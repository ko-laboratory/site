...
<div class="team-member">
  <img src="{{ "/assets/ko-albert.jpg" | relative_url }}" alt="Albert Ko, MD">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Albert Ko, MD</strong></p>
...
<div class="team-member">
  <img src="{{ "/assets/muenker-catherine.jpeg" | relative_url }}" alt="Catherine Muenker, MS">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Catherine Muenker, MS</strong></p>
...
<div class="team-member">
  <img src="{{ "/assets/evankow-chelsea.jpg" | relative_url }}" alt="Chelsea Evankow, MPH">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Chelsea Evankow, MPH</strong></p>
...
<div class="team-member">
  <img src="{{ "/assets/cavalcante-monique.jpeg" | relative_url }}" alt="Monique Cavalcante, MSc, MBA">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Monique Cavalcante, MSc, MBA</strong></p>
...
<div class="team-member">
  <img src="{{ "/assets/aguilar-pablo.jpg" | relative_url }}" alt="Juan Pablo Aguilar Ticona, PhD">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Juan Pablo Aguilar Ticona, PhD</strong></p>
...
<div class="team-member">
  <img src="{{ "/assets/nery-nivison.png" | relative_url }}" alt="Nivison Nery Junior, PhD">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Nivison Nery Junior, PhD</strong></p>
    <p style="font-size: 18px; margin: 0;">Post-doctoral research associate</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/ribeiro-gabriel.jpg" | relative_url }}" alt="Gabriel Ribeiro dos Santos, PhD">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Gabriel Ribeiro dos Santos, PhD</strong></p>
    <p style="font-size: 18px; margin: 0;">Post-doctoral research associate</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/nyathi-sindiso.jpg" | relative_url }}" alt="Sindiso Nyathi, PhD">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Sindiso Nyathi, PhD</strong></p>
    <p style="font-size: 18px; margin: 0;">Post-doctoral research associate</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/cruz-jaqueline.jpg" | relative_url }}" alt="Jaqueline Cruz, PhD">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Jaqueline Cruz, PhD</strong></p>
    <p style="font-size: 18px; margin: 0;">Post-doctoral research associate</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/santos-cleber.jpg" | relative_url }}" alt="Cleber Santos, PhD">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Cleber Santos, PhD</strong></p>
    <p style="font-size: 18px; margin: 0;">Post-doctoral research associate</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/ko-youngsuk.jpg" | relative_url }}" alt="Youngsuk Ko, PhD">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Youngsuk Ko, PhD</strong></p>
    <p style="font-size: 18px; margin: 0;">Post-doctoral research associate</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/khosavanna-ruchira.jpeg" | relative_url }}" alt="Ruchira (Ruth) Khosavanna, MD">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Ruchira (Ruth) Khosavanna, MD</strong></p>
...
<div class="team-member">
  <img src="{{ "/assets/yang-xiaoting.jpg" | relative_url }}" alt="Xiaoting Yang, MPH">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Xiaoting Yang, MPH</strong></p>
    <p style="font-size: 18px; margin: 0;">Fellow</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  ...
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Elisabeth (Zoë) Nelson, MSc</strong></p>
...
<div class="team-member">
  ...
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Lianhan Shang, MD</strong></p>
    <p style="font-size: 18px; margin: 0;">PhD student</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  ...
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Paloma Cárcamo, MD</strong></p>
    <p style="font-size: 18px; margin: 0;">PhD student</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/lin-tzuyi.jpeg" | relative_url }}" alt="Tzu-Yi Lin, MPH">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Tzu-Yi Lin, MPH</strong></p>
