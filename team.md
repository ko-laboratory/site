...
<div class="team-member">
  <img src="{{ "/assets/ko-albert.jpg" | relative_url }}" alt="Albert Ko">
  <div>
...
<div class="team-member">
  <img src="{{ "/assets/muenker-catherine.jpeg" | relative_url }}" alt="Catherine Muenker">
  <div>
...
<div class="team-member">
  <img src="{{ "/assets/aguilar-pablo.jpg" | relative_url }}" alt="Juan Pablo Aguilar">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Juan Pablo Aguilar Ticona</strong></p>
...
<div class="team-member">
  <img src="{{ "/assets/nery-nivison.png" | relative_url }}" alt="Nivison Nery">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Nivison Nery Junior</strong></p>
    <p style="font-size: 18px; margin: 0;">Post-doctoral research associate</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/ribeiro-gabriel.jpg" | relative_url }}" alt="Gabriel Ribeiro dos Santos">
  <div>
...
<div class="team-member">
  <img src="{{ "/assets/nyathi-sindiso.jpg" | relative_url }}" alt="Sindiso Nyathi">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Sindiso Nyathi</strong></p>
    <p style="font-size: 18px; margin: 0;">Post-doctoral research associate</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/cruz-jaqueline.jpg" | relative_url }}" alt="Jaqueline Cruz">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Jaqueline Cruz</strong></p>
    <p style="font-size: 18px; margin: 0;">Post-doctoral research associate</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/santos-cleber.jpg" | relative_url }}" alt="Cleber Santos">
  <div>
...
<div class="team-member">
  <img src="{{ "/assets/ko-youngsuk.jpg" | relative_url }}" alt="Youngsuk Ko">
  <div>
...
<div class="team-member">
  <img src="{{ "/assets/khosavanna-ruchira.jpeg" | relative_url }}" alt="Ruchira (Ruth) Khosavanna">
  <div>
...
<div class="team-member">
  <img src="{{ "/assets/bi-sheng.png" | relative_url }}" alt="Sheng Bi">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Sheng Bi</strong></p>
    <p style="font-size: 18px; margin: 0;">Fellow</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/nelson-elisabeth.jpg" | relative_url }}" alt="Elisabeth Zoe Nelson">
  <div>
...
<div class="team-member">
  <img src="{{ "/assets/shang-lianhan.png" | relative_url }}" alt="Lianhan Shang">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Lianhan Shang</strong></p>
    <p style="font-size: 18px; margin: 0;">PhD student</p>
    <p style="font-size: 14px; margin-top: 5px;">
...
<div class="team-member">
  <img src="{{ "/assets/carcamo-paloma.JPG" | relative_url }}" alt="Paloma Carcamo">
  <div>
...
<div class="team-member">
  <img src="{{ "/assets/satyanarayanan-karthika.jpeg" | relative_url }}" alt="Karthika Satyanarayanan">
  <div>
...
<div class="team-member">
  <img src="{{ "/assets/salazar-sebastian.png" | relative_url }}" alt="Sebastian Salazar">
  <div>
    <p style="font-size: 24px; margin: 0;"><strong>Sebastian Salazar</strong></p>
    <p style="font-size: 18px; margin: 0;">MPH student</p>
    <p style="font-size: 14px; margin-top: 5px;">
